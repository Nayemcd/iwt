...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="#" class="brand-link">
      <img src="../images/195496.png" alt=" Logo" width="154" height="143" style="opacity: .8">
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%">#</th>
                        ...
                        <th width="7%">Sex</th>
                        <th width="7%">SSC GPA.</th>
                        <th width="7%">HSC GPA</th>
                    ...
                    <tbody>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['sscgpa']; ?></div></td>
                        <td><div align="center"><?php echo $row['hscgpa']; ?></div></td>
