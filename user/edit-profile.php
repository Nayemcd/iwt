...
$sql1 = " update admission set fullname='$fullname',sex='$sex',sscgpa='$sscgpa',hscgpa='$hscgpa',faculty='$faculty',dept='$dept',photo='$location' where email='$email'";
   ...
   <option value="Female">Female</option>
				     ...
				     <div class="form-group"><label>Phone</label>
					  <input type="tel" size="77" name="txtphone" value="<?php echo $row['phone'];   ?>" class="form-control" >
					   ...
					   <div class="form-group"><label>SSC GPA</label>
					  <input type="tel" size="77" name="sscgpa" value="<?php echo $row['sscgpa'];   ?>" class="form-control" >
					  </div>
					   <div class="form-group"><label>HSC GPA</label>
					  <input type="tel" size="77" name="hscgpa" value="<?php echo $row['hscgpa'];   ?>" class="form-control" >
					  </div>	
					   </div>
